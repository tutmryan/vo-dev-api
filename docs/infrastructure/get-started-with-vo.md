...
## Install sandbox app into the tenant
...
1. Install sandbox verision of Verified Orchestration app; `az ad sp create --id bbe9101e-a8f2-47f4-95d1-059d3834b910`.
...
1. Enter `Verified Orchestration (sandbox)` into "Search by application name or object ID" text box to locate the newly installed app and then click on it.
...
## Install production app into the tenant

Assuming [Azure Command-Line Interface (CLI)](https://learn.microsoft.com/en-us/cli/azure/) is installed,

1. Log in to the tenant you want to install the app into; `az login --tenant <tenant_id>`.
1. Install sandbox verision of Verified Orchestration app; `az ad sp create --id 78a8e778-b379-4b99-b236-90c920f3a83f`.
1. Navigate to the Azure Active Directory blade in the Azure Portal: <https://portal.azure.com/#view/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/~/Overview>.
1. In the "Manage" section, click on "Enterprise applications".
1. Remove "Application type == Enterprise Applications" filter.
