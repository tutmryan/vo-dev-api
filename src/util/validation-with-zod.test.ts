...
describe('validateClaimInput', () => {
  it('should validate a string claim input successfully', () => {
  ...
  it('should validate a string claim input successfully wihtout optional validation input', () => {
    const input = createClaimInput({
      type: ClaimType.String,
      value: 'example',
    })
  ...
  it('should validate an int claim input successfully', () => {
    const input = createClaimInput({
      type: ClaimType.Int,
      value: '50',
  ...
  it('should validate an int claim input successfully wihtout optional validation input', () => {
    const input = createClaimInput({
      type: ClaimType.Int,
      value: '50',
    })
  ...
  it('should validate a float claim input successfully', () => {
    const input = createClaimInput({
  ...
  it('should validate a float claim input successfully wihtout optional validation input', () => {
    const input = createClaimInput({
      type: ClaimType.Float,
      value: '50.5',
    })
  ...
  it('should validate a list claim input successfully', () => {
    const input = createClaimInput({
      type: ClaimType.List,
      value: 'Option1',
  ...
  it('should validate a regex claim input successfully', () => {
    const input = createClaimInput({
  ...
  it('should throw an error for regex claim input when required validation rules are missing', () => {
    const input = createClaimInput({
      type: ClaimType.Regex,
      value: undefined,
      validation: undefined,
  ...
  it('should throw an error for list claim input when required validation rules are missing', () => {
    const input = createClaimInput({
      type: ClaimType.List,
      value: undefined,
      validation: undefined,
  ...
  it('should throw an error if list validation is missing for a list claim input', () => {
    const input = createClaimInput({
      type: ClaimType.List,
      value: 'Option1',
      validation: undefined,
  ...
  it('should throw an error if regex validation is missing for a regex claim input', () => {
    const input = createClaimInput({
      type: ClaimType.Regex,
      value: 'abc',
      validation: undefined,
