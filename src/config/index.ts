...
export const useManagedRedis = config.has('useManagedRedis') ? config.get('useManagedRedis') : false
export const managedRedis = config.has('managedRedis') ? config.get('managedRedis') : undefined
...
export const mdoc = config.get('mdoc')
...
export const limitedPresentationFlow = config.get('limitedPresentationFlow')
