...
export type Authority = {
  ...
  linkedDomainsVerified: Scalars['Boolean'];
...
export type ConfigurationValidation = {
  ...
  allowRevoked?: InputMaybe<Scalars['Boolean']>;
  ...
  validateLinkedDomain?: InputMaybe<Scalars['Boolean']>;
};
...
export type DidModel = {
  ...
  signingKeys: Array<Scalars['String']>;
};
...
export type IonDidModel = DidModel & {
  ...
  did: Scalars['ID'];
  didDocumentStatus: DidDocumentStatus;
  encryptionKeys: Array<Scalars['String']>;
  linkedDomainUrls: Array<Scalars['URL']>;
  /** URL to the recovery  key */
  recoveryKeys: Array<Scalars['String']>;
  signingKeys: Array<Scalars['String']>;
...
export type IssuanceRequestInput = {
   ...
   */
  claims?: InputMaybe<Scalars['JSONObject']>;
   ...
   */
  includeQRCode?: InputMaybe<Scalars['Boolean']>;
  pin?: InputMaybe<Pin>;
  /**
...
export type Mutation = {
  ...
  deleteContract?: Maybe<Scalars['Void']>;
...
export type PresentationRequestInput = {
   ...
   */
  includeReceipt?: InputMaybe<Scalars['Boolean']>;
...
export type RequestCredential = {
   ...
   */
  acceptedIssuers?: InputMaybe<Array<Scalars['String']>>;
  /** Optional settings for presentation validation. */
  configuration?: InputMaybe<RequestConfiguration>;
  /** Provide information about the purpose of requesting this verifiable credential. */
  purpose?: InputMaybe<Scalars['String']>;
...
export type PresentationCallbackEventResolvers<ContextType = GraphQLContext, ParentType extends ResolversParentTypes['PresentationCallbackEvent'] = ResolversParentTypes['PresentationCallbackEvent']> = {
  ...
  verifiedCredentialsData?: Resolver<Array<ResolversTypes['PresentedCredential']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
