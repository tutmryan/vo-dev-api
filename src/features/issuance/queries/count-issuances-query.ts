...
import type { IssuanceCountWhere, Maybe } from '../../../generated/graphql'
...
export async function CountIssuancesQuery(this: QueryContext, criteria?: Maybe<IssuanceCountWhere>) {
