...
describe('MicrosoftEntraTemporaryAccessPassService', () => {
  ...
  beforeEach(() => {
    ...
    jest.spyOn(graphServiceManager, 'get').mockResolvedValue(mockGraphService as unknown as GraphService)
  ...
  describe('getAvailableSelfServiceActions', () => {
    ...
    it('returns descriptive reason when service is not configured', async () => {
      ...
      jest.spyOn(graphServiceManager, 'get').mockResolvedValueOnce(undefined)
