...
import { SetInstanceSettingCommand } from './commands/set-instance-setting-command'
...
import { FindInstanceSettingQuery } from './queries/find-instance-setting-query'
...
export const resolvers: Resolvers = {
  Query: {
    ...
    instanceSetting: (_parent, { key }, context) => query(context, FindInstanceSettingQuery, key),
  },
  Mutation: {
    ...
    setInstanceSetting: (_parent, { input }, context) => dispatch(context, SetInstanceSettingCommand, input.key, input.value),
  },
}
