import { faceCheckEnabled, mdoc } from '../config'
...
export const isMDocPresentationsEnabled = () => {
  if (!mdoc.presentationsEnabled) throw new Error('ISO 18013-5 (mDL) presentation feature is not available')
}
