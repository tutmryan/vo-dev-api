...
### Using [`verifyPresentation`](/api-reference/operations/queries/verify-presentation) query
...
:::tip
You can query for your Verifier's DID using [`Authority query`](/api-reference/operations/queries/authority)
:::
