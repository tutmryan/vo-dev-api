...
:::tip
Issuance received events can be received via the IssuanceEvent subscription and the server-side callback, however you cannot poll for issuance recevied events because they are not stored. See the TODO for further details.
:::
...
:::tip
For complete code samples of different methods of receiving issuance events, see the issuance samples TODO.
:::
