...
1. [Issue](/docs/guides/integration/javascript-client/issuance) or [present](/docs/guides/integration/javascript-client/presentations) credentials (for more info, refer to complete examples below)
...
- [Presentations](/docs/guides/integration/javascript-client/presentations)
