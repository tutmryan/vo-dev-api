...
Apollo Studio is a GraphQL IDE that enables you to explore the Verified Orchestration API. It's an ideal tool for delving into the schema, building and running queries, as well as referencing the documentation.

You will need to be [onboarded as a platform user](../onboarding-users.mdx) to access Apollo Studio and the API.

<ApiLink>Access Apollo Studio here</ApiLink>

#### Basic Apollo Studio usage
...
1. Insert the Authorization header into the **Headers** section in Apollo Studio
