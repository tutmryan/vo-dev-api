...
import { PortalLink } from '@site/src/components/PortalLink'
...
:::note
Remote issuance requests and their completed credentials are visible together with in-person issuances in the <AdminLink path="/credentials">Credentials</AdminLink> view in Composer.
:::
...
- <PortalLink path='/issuance/$issuanceId'>OTP verification</PortalLink>
- <PortalLink path='/issue/$issuanceId'>Concierge sign-in verification</PortalLink>
...
Each row represents a single [async issuance request](/api-reference/types/inputs/async-issuance-request-input) and each column corresponds to a field.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>[AsyncIssuanceRequestInput.identity.identifier](/api-reference/types/inputs/identity-input#identityinputidentifierstring--)</td>
      <td>Unique identifier of the identity (see [Identity mapping](/docs/guides/identity-mapping) guide)</td>
    </tr>
    <tr>
      <td>Identity Issuer</td>
      <td>[AsyncIssuanceRequestInput.identity.issuer](/api-reference/types/inputs/identity-input#identityinputissuerstring--)</td>
      <td>Issuer of the identity (see [Identity mapping](/docs/guides/identity-mapping) guide)</td>
    </tr>
    <tr>
      <td>Recipient Name</td>
      <td>[AsyncIssuanceRequestInput.identity.name](/api-reference/types/inputs/identity-input#identityinputnamestring--)</td>
      <td>Name of the identity (see [Identity mapping](/docs/guides/identity-mapping) guide)</td>
    </tr>
    <tr>
      <td>(Optional) Notification Method (email | sms)</td>
      <td>
        [AsyncIssuanceRequestInput.contact.notification.method](/api-reference/types/inputs/async-issuance-contact-input#asyncissuancecontactinputnotificationcontactinput-)
      </td>
      <td>["email" or "sms"](/api-reference/types/enums/contact-method)</td>
    </tr>
    <tr>
      <td>(Optional) Notification Value</td>
      <td>
        [AsyncIssuanceRequestInput.contact.notification.value](/api-reference/types/inputs/async-issuance-contact-input#asyncissuancecontactinputnotificationcontactinput-)
      </td>
    ...
    <tr>
      ...
      <td>
        [AsyncIssuanceRequestInput.contact.verification.method](/api-reference/types/inputs/async-issuance-contact-input#asyncissuancecontactinputverificationcontactinput-)
      </td>
      <td>["email" or "sms"](/api-reference/types/enums/contact-method)</td>
    </tr>
    <tr>
      ...
      <td>
        [AsyncIssuanceRequestInput.contact.verification.value](/api-reference/types/inputs/async-issuance-contact-input#asyncissuancecontactinputverificationcontactinput-)
      </td>
    ...
    <tr>
      ...
      <td>
        [AsyncIssuanceRequestInput.expiry](/api-reference/types/inputs/async-issuance-request-input#asyncissuancerequestinputexpiryasyncissuancerequestexpiry--)
      </td>
      <td>
        ["oneDay" or "threeDays" or "oneWeek" or "twoWeeks" or "oneMonth" or
        "threeMonths"](/api-reference/types/enums/async-issuance-request-expiry)
      </td>
    </tr>
    <tr>
      <td>(Optional) - Credential Expiry Date</td>
      <td>
        [AsyncIssuanceRequestInput.expirationDate](/api-reference/types/inputs/async-issuance-request-input#asyncissuancerequestinputexpirationdatedatetime-)
      </td>
      <td>[Date-time string in ISO 8601 format](/api-reference/types/scalars/date-time)</td>
    </tr>
    <tr>
      <td>(Optional) - Post issuance redirect url</td>
      <td>
        [AsyncIssuanceRequestInput.postIssuanceRedirectUrl](/api-reference/types/inputs/async-issuance-request-input#asyncissuancerequestinputpostissuanceredirecturlurl-)
      </td>
...
The [async issuance request input](/api-reference/types/inputs/async-issuance-request-input) specifies:
