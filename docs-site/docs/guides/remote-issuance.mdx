...
:::warning
Both the Admin portal and the API have a hard limit of creating no more than 1000 remote issuances at one time.

- When using the Admin portal, you can split the CSV file into multiple files and upload them separately.
