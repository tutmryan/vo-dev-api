...
The [acquireLimitedAccessToken](/docs/reference/mutations/acquire-limited-access-token) mutation returns an access token with specific capabilities according to the [AcquireLimitedAccessTokenInput](/docs/reference/inputs/acquire-limited-access-token-input):
