...
Individuals who would like to access the <AdminLink path='/'>Composer</AdminLink> or <ApiLink path='/'>GraphQL API</ApiLink> will need to be granted access via Verified Orchestration enterprise application user roles.
...
- all the permissions of [Reader](#reader) role, and
- add, edit, and delete instance configurations (e.g., branding).
