...
1. `{yourInstanceUrl}/oidc/auth`
2. `{yourInstanceUrl}/oidc/.well-known/openid-configuration`
3. `{yourTenantUrl}` <Help>(which should resemble the format of `https://{tenantName}.onmicrosoft.com`)</Help>
...
2. Discovery Endpoint
    1. The discovery endpoint of the VO platform instance. Which is, `{yourInstanceUrl}/oidc/.well-known/openid-configuration`.
3. App ID
