...
The <AdminUrl path='/oidc'>Composer authentication page</AdminUrl> displays the:
...
1. Navigate to the <AdminUrl path='/oidc'>Composer authentication page</AdminUrl>.
...
\* The `email` scope only results in a claim value when an `email` claim is present in the verifiable credential presentation.
