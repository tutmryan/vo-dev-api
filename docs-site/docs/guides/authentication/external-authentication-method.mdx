...
When using External Authentication Method (EAM) with a tenant other than your home tenant, the Verified Orchestration platform must know about it. For more information, see [additional tenant IDs](/docs/guides/instance-configuration#additional-tenant-ids).
...
1. Register an enterprise application/application in Entra ID.
    1. The application will be used to store key OIDC URIs as SPA Redirect URIs.
