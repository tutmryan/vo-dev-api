...
From the Presentation Builder area of the Verified Orchestration Admin UI:
...
From the <PortalUrl path='/demo/presentation'>Verified Orchestration portal presentation demo</PortalUrl>, you can also execute a presentation request and explore the data available as a result of the data sharing.
...
To prepare a presentation request, in the Admin UI, visit the **Presentation builder** area. You will be presented the following screen:
...
:::note[**Apollo Sandbox**]
We provide the <ApiUrl path='/'>Apollo Sandbox</ApiUrl> for non-production instances of Verified Orchestration, to streamline the integration and testing of verifiable credentials into your applications.
:::
...
The presentation request will complete and the portal will show you the result of the presentation request, including additional meta-data showing:
