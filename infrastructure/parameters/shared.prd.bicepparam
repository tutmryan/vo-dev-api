...
param elasticPoolEdition = 'BC_Gen5'
param elasticPoolCapacity = 4
param elasticPoolPerDatabaseMaxCapacity = 4
param elasticPoolZoneRedundant = true
param appServicePlanSku = 'P1MV3'
param appServicePlanCapacity = 4
